...
const Hero = (): JSX.Element => {
  return (
    <section
      className="pt-32 pb-8 sm:pb-16 px-4 sm:px-8 max-w-5xl mx-auto text-center"
    >
      <span className="inline-flex items-center gap-2 rounded-full bg-primary/10 text-primary text-sm font-medium px-4 py-1.5 mb-6">
        ...
        10 Practical Courses, One Platform
      </span>
      ...
      <p className="mt-6 text-base-content/70 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
        DigitalHub brings together everything you need to register a business, build an
        online income, and grow with confidence — from CAC registration and web development
        to forex, AI automation, and digital products. No beating around the bush, just clear, step-by-step
        guides built to get you results.
      </p>
